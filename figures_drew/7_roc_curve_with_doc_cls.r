...
# 
auc <- data.frame(x = 0.75, y = 0.062, text = c('ROC curve (Area = 0.82)'))
...
ggplot(roc_table, aes(x = FPR, y = TPR))+
  ...
  labs(title = 'Subtype ROC Curve', y = 'Sensitivity', x = '1 - specificity')+
  theme_bw()+
...
ggplot(roc_table, aes(x = FPR, y = TPR))+
  ...
  labs(title = 'Stage ROC Curve',  y = 'Sensitivity', x = '1 - specificity')+
  theme_bw()+
  theme(plot.title = element_text(size = 55,hjust = 0.5),
        axis.text.x = element_text(size =45),
        axis.text.y = element_text(size =45),
...
ggplot(roc_table, aes(x = FPR, y = TPR))+
  ...
  labs(title = 'Grade ROC Curve',  y = 'Sensitivity', x = '1 - specificity')+
  theme_bw()+
  theme(plot.title = element_text(size = 55,hjust = 0.5),
        axis.text.x = element_text(size =45),
        axis.text.y = element_text(size =45),
