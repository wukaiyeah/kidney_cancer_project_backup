...
from preprocess.load_data_and_resize_to_target_spacing import load_data_and_resize
from preprocess.image_analyze import image_analyze, tumor_size_filter
from preprocess.mask_to_gtboxes import gt_boxes_generate
from preprocess.image_region_crop import tumor_size_stats,crop_image
from preprocess.image_normlize import image_normalize
from preprocess.image_augmentation import image_augment
...
def prepare_dataset(images_dir, masks_dir):
    ...
    for file_id in files_id:
        ...
        image_dir = os.path.join(images_dir, file_id+'.nii.gz')
